...
export default class Trakt {
    public movies = {
        ...
        releases: (params: {
            ...
            this._call(
                "get",
                `/movies/${params.id}/releases${params.country ? `/${params.country}` : ""
                }`,
            ),
        translations: (params: {
            id: string;
            ...
            this._call(
                "get",
                `/movies/${params.id}/translations${params.language ? `/${params.language}` : ""
                }`,
            ),
    ...
    public shows = {
        ...
        trending: (
            ...
            this._call("get", "/shows/trending", params),
        ...
        translations: (params: {
            ...
            this._call(
                "get",
                `/shows/${params.id}/translations${params.language ? `/${params.language}` : ""
                }`,
            ),
        comments: (params: { id: string }) =>
    ...
    public users = {
        ...
        history: (params: {
            ...
            this._call(
                "get",
                `/users/${params.id}/history${params.type ? `/${params.type}` : ""}${params.item_id ? `/${params.item_id}` : ""
        ...
        ratings: (params: {
            ...
            this._call(
                "get",
                `/users/${params.id}/ratings/${params.type}${params.rating ? `/${params.rating}` : ""
                }`,
            ),
        watchlist: (params: {
            id: string;
    ...
    public getUrl(): string {
        ...
        return `${baseUrl}/oauth/authorize?response_type=code&client_id=${this.settings.client_id}&redirect_uri=${this.settings.redirect_uri || "urn:ietf:wg:oauth:2.0:oob"
